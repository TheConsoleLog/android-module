                ...
                ModalDrawerSheet(modifier = Modifier.fillMaxWidth(0.6f)) {
                    ...
                    CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Ltr) {
                        ...
                        NavigationDrawerItem(
                            ...
                            icon = { Icon(painter = painterResource(R.drawable.baseline_logout_24), null) }
                        )
                    }
                }
            }
                        ...
                        is Resource.Success -> {
                            ...
                            if(firstVisibleItem.value >= 2){
                                FloatingActionButton(
                                    onClick = { lazyListScope.launch {
                                        lazyListState.animateScrollToItem(0)
                                    } },
                                    modifier = Modifier.align(Alignment.BottomEnd).zIndex(1f).padding(16.dp)    //zIndex for stacking inside Box
                                ) {
